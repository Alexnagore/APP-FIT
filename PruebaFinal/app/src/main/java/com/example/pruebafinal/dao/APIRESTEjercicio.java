...
public class APIRESTEjercicio implements EjercicioInterface {
    ...
    public void agregarEjercicio(Ejercicio ejercicio) {
        ...
        try{
            ...
            if(response.isSuccessful()) {
                ...
                ejercicio.setObjectId(newEjercicio.getObjectId());
            }
    ...
    public Ejercicio getEjercicio(Ejercicio ejercicio) {
        ...
        try {
            ...
            if(response.isSuccessful()) {
                String responseJson = response.body().string();
                Gson gson = new Gson();
                result = gson.fromJson(responseJson, Ejercicio.class);
            }
        } catch (IOException ex){
            System.out.println("Error: " + ex.getMessage());
        }
    ...
    public void actualizaEjercicios(Ejercicio ejercicio) {
        ...
        try{
            ...
            if(response.isSuccessful()) {
                ...
                System.out.println("Fallo en la actualizacion. Code: " + response.code() + ". Mess: " + response.toString());
            }
        } catch (IOException ex) {
            System.out.println("Error: " + ex.getMessage());
        }
    ...
    public void setListaEjercicios(List<Ejercicio> listaEjercicios) {
        // Este método no tiene implementación directa en la API REST
        // Se podría implementar eliminando todos los ejercicios y agregando los nuevos
        System.out.println("Método no implementado para API REST");
    }
}