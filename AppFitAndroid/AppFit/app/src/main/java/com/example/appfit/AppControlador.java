...
public class AppControlador {
    ...
    public AppControlador(){
        ...
        Ejercicio ej1 = new Ejercicio("ej1", 1000, 13, puntoInicial,puntoFinal, 1);
        Ejercicio ej2 = new Ejercicio("ej2", 2000, 50, puntoInicial,puntoFinal, 2);
        Ejercicio ej3 = new Ejercicio("ej3", 3000, 20, puntoInicial,puntoFinal, 3);
        ...
        Entrenamiento en1 = new Entrenamiento(1);
        en1.agregarEjercicio(ej1);
        en1.agregarEjercicio(ej2);

        Entrenamiento en2 = new Entrenamiento(2);
        ...
        Usuario usuario1 = new Usuario("Martin", "Orenes", "mo@hotmail.com", "cont", 1);
        Usuario usuario2 = new Usuario("Javier", "Merino", "jm@hotmail.com", "contr", 2);
        Usuario usuario3 = new Usuario("Alex", "Nagore", "an@hotmail.com", "contra", 3);
